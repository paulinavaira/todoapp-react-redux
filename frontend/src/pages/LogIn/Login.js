...
const LogIn = (props) => {
    ...
    <>
        <div class="justify-content-center align-items-center h-100 mt-5">
            <h2 style={{color:'#ffffff'}} class="text-center">Log In</h2>
            <div style={{display:'flex', justifyContent: 'center' }}>
                <form class="form-group col-md-4">
                    ...
                    <button style={{backgroundColor:'#6fffe9', color:'#3a506b'}} type="submit" class="btn btn-dark mt-3 col-md-12" onClick={sendUser}>Log In</button>
                </form>
            </div>
            <div style={{color:'#ffffff'}} class="text-center">You do not have an account? <NavLink style={{color:'#6fffe9'}} to="/signup">Create here</NavLink></div>
            <ToastContainer
